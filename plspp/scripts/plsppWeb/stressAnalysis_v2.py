###############
#
# stressAnalysis_v2.py
#
# Script for lexical stress analysis.
# Arguments:
#   - path to folder with textgrids files, each textgrid containing following a tier of word-level part-of-speech, transcription and an optionnal point tier indicating accoustical syllable nuclei
#   - path to audio folder in wav format
#   - path to output textgrid folder
#   - path to stress dictionary with following format: "effect":["oO","Oo"]
#
# Outputs:
#   - one textgrid file per audio file, containing already existing tiers + new following tiers: Exp, Obs, Detail, ObsNum, DetailNum
#
# S. Coulange 2025
...
dictionary = sys.argv[4] # stress dictionary
...
# List of vowels from ARPABET and SAMPA phonetic transcriptions
arpavowels = [ "AA", "AE", "AH", "AO", "AW", "AY", "EH", "ER", "EY", "IH", "IY", "OW", "OY", "UH", "UW"]
sampavowels = ["{", "{I", "{O", "}:", "@", "@}", "@`", "@U", "3:", "3`", "6", "6:", "A", "A:", "Ae", "aI", "Ar\\", "aU", "e", "E", "e:", "E@", "eI", "er\\", "i", "I", "i:", "I@", "ir\\", "j}:", "ju", "ju:", "O", "o:", "O:", "oI", "OI", "oU", "Q", "u", "U", "u:", "U@", "Ur\\", "V"]
ipavowels = ["æ","æɪ","æɔ","aɪ","aʊ","ɐ","ɐː","ɑ","ɑː","ɑɪ","ɑɹ","ɒ","e","eː","eɪ","eɹ","ə","əʉ","əʊ","ɛ","ɛə","ɚ","ɜː","ɝ","i","iː","iɹ","ɪ","ɪə","ju","juː","jʉː","o","oː","oɪ","oʊ","ɔ","ɔː","ɔɪ","u","uː","ʉː","ʊ","ʊə","ʊɹ","ʌ"]
