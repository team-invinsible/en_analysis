...
import re, os, praat_textgrids as textgrids, parselmouth, statistics, random, string, sys
    ...
    for file in os.listdir(input_folder):
        ...
        for i,intervalle in enumerate(grid['words']):
            ...
            if lab != "<p:>" and lab != "":
                ...
                thisStressWord = ["" for x in range(0,40)] # Init to empty vector
                ...
                outf.write(';'.join([
                    ...
                    format(thisStressWord[header.index("F0min")]),	
                    format(thisStressWord[header.index("F0max")]),	
                    format(thisStressWord[header.index("F0sd")]),	
                    format(thisStressWord[header.index("syllmfa_equals_syllnuclei")]),
