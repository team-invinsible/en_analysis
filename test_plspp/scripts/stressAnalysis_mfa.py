...
import re, os, textgrids, parselmouth, statistics, random, string, sys, numpy
...
for file in os.listdir(input_folder):
    ...
    # LOOP ON INTERVALLES → CHECK IF PLURISYLLABIC WORD & WORD IN DICTIONARY → ACOUSTIC MEASURES ON EACH SYLLABLE
        ...
        if lab != "":
            ...
            if lab.lower() in gabarits.keys():
                ...
                if ok:
                    ...
                    # GetPOS
                    posIntNb = call(tg, "Get interval at time...", 1, vowelIntervals[0].xmax)
